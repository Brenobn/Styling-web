        ...
        >
          <div className="grid-cols-form grid gap-3">
            ...
            <div className="grid grid-cols-2 gap-6 pb-5">
              ...
              <Input.Root>
                <Input.Control defaultValue="Barcelos" />
              </Input.Root>
            </div>
          </div>
          ...
          <div className="grid-cols-form grid gap-3 pb-5">
            ...
            <div className="flex items-start gap-5">
              ...
              <label
                htmlFor="photo"
                className="group hover:bg-violet-25 hover:bg-violet-25 flex flex-1 cursor-pointer flex-col items-center gap-3 rounded-lg border border-zinc-300 px-6 py-4 text-center text-zinc-500 shadow-sm hover:border-violet-200 hover:bg-[#fcfaff] hover:text-violet-500"
              >
